    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-6">
                ...
                <p>Payment Status: <?php echo $paid == 0 ? '<span class="badge badge-secondary">Unpaid</span>' : '<span class="badge badge-success">Paid</span>' ?></p>
            </div>
...
<div class="modal-footer">
    ...
    <button type="button" class="btn btn-secondary" data-dismiss="modal" onClick="window.print()">Print this page</button>
</div>
<?php if(isset($_GET['view'])): ?>
<style>
