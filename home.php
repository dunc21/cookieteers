 ...
 <header class="bg-dark py-5" id="main-header">
    <div class="container px-4 px-lg-5 my-5">
        <div class="text-center text-white">
            <h1 class="display-4 fw-bolder">"Indulge in the Sweet Moments with our Irresistible Cookies!"</h1>
            <p class="lead fw-normal text-white-50 mb-0">The Cookieteers aim to make the best out of their kitchen tools and ingredients by sharing a variety of flavorful and freshly-baked cookies --- all made with love and craftiness!</p>
        </div>
    </div>
</header>
<!-- Section-->
